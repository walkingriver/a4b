...
I could drop the `tap` and do both the variable assignment and the service call inside of the `switchMap` operator. I may eventually do that, but for now I like the way that each step is visually separated.
